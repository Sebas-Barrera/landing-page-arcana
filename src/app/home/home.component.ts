...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  readonly membershipPlans = signal([
    ...
    },
    {
      ...
      period: '/mes',
      description:
        'Acceso completo a la plataforma con funcionalidades esenciales',
      features: [
        'Acceso completo a la plataforma',
        'Consejos y artículos diarios',
        'Rituales y tutoriales',
    ...
    },
    {
      ...
      period: '/mes',
      description:
        'Todo lo de la básica más beneficios exclusivos premium',
      features: [
        'Todo lo de la básica',
        'Artículo mágico mensual',
    ...
    },
    {
      ...
      period: '/año',
      description:
        'Inversión anual con beneficios exclusivos y ahorro garantizado',
      features: [
        'Todo lo de la premium',
        'Kit de bienvenida Arcana',
        'Ahorro de $1,189 al año',
        'Sesiones energéticas personalizadas',
      ],
      buttonText: 'Próximamente',
      popular: false,
      color: 'border-purple-400',
